...
public class SlidingRootNavBuilder {
    ...
    public SlidingRootNavBuilder withRootViewXTranslation(int translation, Activity activity) {
        return withRootViewXTranslationPx(dpToPx(translation), activity);
    }

    public SlidingRootNavBuilder withRootViewXTranslationPx(int translation, Activity activity) {
        transformations.add(new XTranslationTransformation(translation, activity));
        return this;
    }
